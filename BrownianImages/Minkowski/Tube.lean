...
/-- The tube cutoff is at most one. -/
...
/-- The tube cutoff equals one on the set itself. -/
@[simp]
...
/-- The tube cutoff is positive exactly within distance `r` of the set. -/
...
/-- The tube cutoff vanishes exactly at distance at least `r` from the set. -/
...
/-- The smoothed tube mass is non-negative. -/
...
/-- The smoothed tube mass is a measurable function of the compact set. -/
...
/-- The smoothed tube measure of a nonempty compact set is not the zero measure. -/
...
/-- The smoothed tube probability is a measurable function of the compact set. -/
...
/-- The `n`-th tube radius is positive. -/
...
/-- The `n`-th tube probability is continuous in the compact set. -/
theorem continuous_tubeProbabilitySeq (n : ℕ) : Continuous (tubeProbabilitySeq n) :=
  continuous_tubeProbability (tubeRadius_pos n)

/-- The `n`-th tube probability is measurable in the compact set. -/
