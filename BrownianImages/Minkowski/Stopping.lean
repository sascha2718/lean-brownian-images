...
The fixed-generation words in `Minkowski.Generation` compose new letters on
...
omit [Nonempty iota] in
/-- The underlying set of a stopping cylinder is the image of the attractor under the
word's map. -/
@[simp]
...
/-- The stopping leaves below a word form a finite type. -/
...
/-- There is always a stopping leaf below a word. -/
