...
/-- The strongly measurable representative of the Brownian value at time `t`. -/
...
/-- The representative agrees with the Brownian value almost surely. -/
...
/-- The times of the `N`-th grid are monotone in the index. -/
...
/-- Each grid sample is strongly measurable. -/
...
/-- Each grid sample agrees almost surely with the Brownian value at its grid time. -/
...
/-- Grid times add and subtract as non-negative reals along an increasing pair of
indices. -/
