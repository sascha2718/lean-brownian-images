...
/-- The indicator of the `r`-tube of a compact set is integrable. -/
...
/-- The integral of the tube indicator is the tube area. -/
...
/-- The reflected tube indicator is integrable. -/
...
/-- The reflected tube indicator has the tube area as its integral, by reflection
...
/-- The overlap area of two tubes is non-negative. -/
