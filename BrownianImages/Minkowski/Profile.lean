...
construction in `Minkowski.Tube` separate from the probabilistic estimates.
-/
...
/-- The tube radius at real logarithmic scale `t` is positive. -/
...
/-- The normalised tube mass is non-negative. -/
