...
/-- The radius of the rescaled Brownian image on an affine interval is almost everywhere
measurable. -/
...
/-- The radius of the Brownian image on `[0,1]` is almost everywhere measurable. -/
...
/-- The oscillation radius of a Brownian path on an interval is non-negative. -/
